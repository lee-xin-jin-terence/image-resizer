package com.terence.imageresizer.models;
...
public class ImageResizer {
     ...
     * */
    public static byte[] resizeImage(MultipartFile imageMultipartFile, int percentageReductionOfImageSize)
            throws IOException {
     ...
     * */
    private static void validatePercentageReductionOfImageSize(int percentageReductionOfImageSize){
     ...
     * */
    private static BufferedImage convertMultipartFileToBufferedImage(MultipartFile multipartFile) throws IOException {
     ...
     *               between 1%(inclusive) and 99%(inclusive)
     * */
    private static BufferedImage resizeImage(BufferedImage imageToResize, int percentageReductionOfImageSize){
